    ...
    <div>
        ...
        <div class="container">
            <div class="handle-box">
                ...
                >批量删除</el-button>-->
                <el-input v-model="query.code" placeholder="公告" class="handle-input mr10"></el-input>
                <el-button type="primary" icon="el-icon-search" @click="handleSearch">搜索</el-button>
                <el-button type="primary" icon="el-icon-plus" @click="handleAdd('add')">新建公告</el-button>
            </div>
            <el-table
                :data="tableData"
                border
            ...
            >
                ...
                <el-table-column prop="name" label="公告标题" align="center">
                    <template slot-scope="scope">{{scope.row.action_title}}</template>
                </el-table-column>
                <el-table-column label="公告内容" align="center">
                    <template slot-scope="scope">{{scope.row.action_content}}</template>
                </el-table-column>
        ...
        <el-dialog :title="titleType" :visible.sync="editVisible" width="30%">
            <el-form ref="codeForm" :model="codeForm" label-width="120px">
                ...
                >
                    <el-input v-model="codeForm.action_title"></el-input>
                </el-form-item>
                <el-form-item
                    label="公告内容"
                    prop="action_content"
                ...
                >
                    <el-input
                        ...
                        placeholder="请输入内容"
                        v-model="codeForm.action_content"
                    ></el-input>
                </el-form-item>
            </el-form>
...
<script>
import { getAllAction, deleteAction, editAction, addAction } from '../../api/action';
export default {
    ...
    methods: {
        getData() {
            getAllAction({ code: this.query.code, page: this.query.pageIndex }).then(res => {
        ...
        saveAdd() {
            this.$refs['codeForm'].validate(valid => {
                if (valid) {
                    ...
                    // return;
                    addAction(this.codeForm).then(res => {
        ...
        saveEdit() {
            this.$refs['codeForm'].validate(valid => {
                if (valid) {
                    ...
                    // return;
                    editAction(this.codeForm).then(res => {
                        // console.log('aaaaaaaaa', res.data);
                        this.editVisible = false;
